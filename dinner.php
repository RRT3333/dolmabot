...
function getdinner($days)
{
  ...
  $URL = "https://stu.goe.go.kr/sts_sci_md01_001.do?schulCode=J100004768&&schulCrseScCode=3&schMmealScCode=3&schYmd=" . $date; // DOMDocument
  //How to get schoolcode?
  //https://code.schoolmenukr.ml/
  //급식파셔 참고   https://github.com/agemor/neis-api
